...
export class MyWeb extends Component<MyWebProps> {
  ...
  handleDeepLink = (url: string) => {
    ...
    if (parsedUrl.scheme === 'myapp') {
      ...
      // Extract the redirect URL from the magic link
      const queryParams = parsedUrl.queryParams || {};
      const redirectUrl = queryParams.redirect_to;
      // Navigate to the LoggedIn screen
      this.props.navigation.navigate('LoggedIn', { uri: redirectUrl });
    }
  };
...
export const MyWebScreen = ({ navigation }: { navigation: NativeStackNavigationProp<any> }) => {
  return <MyWeb navigation={navigation} />;
};
